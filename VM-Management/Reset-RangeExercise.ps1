...
.PARAMETER Folder
    Optional. The vSphere folder / network containing the exercise VMs (e.g. "CL1", "CL5", "IRDev").
...
.EXAMPLE
    .\Reset-RangeExercise.ps1 -SnapshotName "Clean-State" -DryRun
    Connect, pick a network / folder from the list, then preview the revert plan.
